...
type FastChainContext interface {
	...
	GetHeader(common.Hash, uint64) *types.FastHeader
}

// NewEVMContext creates a new context for use in the EVM.
func NewFastEVMContext(msg Message, header *types.FastHeader, chain FastChainContext, author *common.Address) vm.Context {
