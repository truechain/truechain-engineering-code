...
func (c *ChainIndexer) Start(chain ChainIndexerChain) {
	events := make(chan types.ChainFastEvent, 10)
...
// queue.
func (c *ChainIndexer) eventLoop(currentHeader *types.Header, events chan types.ChainFastEvent, sub event.Subscription) {
