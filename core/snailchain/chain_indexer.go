...
type ChainIndexerBackend interface {
	...
	Process(ctx context.Context, header *types.SnailHeader) error
...
func (c *ChainIndexer) Start(chain ChainIndexerChain) {
	events := make(chan types.SnailChainHeadEvent, 10)
...
// queue.
func (c *ChainIndexer) eventLoop(currentHeader *types.SnailHeader, events chan types.SnailChainHeadEvent, sub event.Subscription) {
