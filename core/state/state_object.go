...
func Compare(obj0 *Account, obj1 *Account) bool {
	switch {
	case obj0 == nil && obj1 == nil:
		return true
	case obj0 == nil || obj1 == nil:
		return false
	case obj0.Balance.Cmp(obj1.Balance) != 0 || !bytes.Equal(obj0.CodeHash, obj1.CodeHash) || obj0.Nonce != obj1.Nonce:
		return false
	default:
		return true
	}
