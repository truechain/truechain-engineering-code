...
//func loadAndParseJournal(db etruedb.KeyValueStore, base *diskLayer) (snapshot, journalGenerator, error) {
...
//func loadSnapshot(diskdb etruedb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, recovery bool) (snapshot, bool, error) {
