...
func wipeSnapshot(db etruedb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db etruedb.KeyValueStore) error {
...
func wipeKeyRange(db etruedb.KeyValueStore, kind string, prefix []byte, origin []byte, limit []byte, keylen int, meter metrics.Meter, report bool) error {
