...
func (b *benchmarkBlockHeaders) request(peer *peer, index int) error {
	if b.byHash {
		return peer.RequestHeadersByHash(0, 0, b.hashes[index], b.amount, b.skip, b.reverse, true, false)
	} else {
		return peer.RequestHeadersByNumber(0, 0, uint64(b.offset+rand.Int63n(b.randMax)), b.amount, b.skip, b.reverse, true)
	}
}
...
func (b *benchmarkTxSend) init(pm *ProtocolManager, count int) error {
	...
	signer := types.NewTIP1Signer(big.NewInt(18))
