...
func (c *BoundContract) transact(opts *TransactOpts, contract *common.Address, input []byte) (*types.Transaction, error) {
	...
	if gasLimit == 0 {
		...
		msg := truechain.CallMsg{From: opts.From, To: contract, GasPrice: opts.GasPrice, Value: value, Data: input}
	...
	if contract == nil {
		...
		rawTx = types.NewTransaction(nonce, c.address, value, gasLimit, opts.GasPrice, input)
	}
	if opts.Signer == nil {
