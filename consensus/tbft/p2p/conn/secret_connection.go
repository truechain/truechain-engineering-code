...
func shareEphPubKey(conn io.ReadWriteCloser, locEphPub *[32]byte) (remEphPub *[32]byte, err error) {
	...
	var trs, _ = help.Parallel(
		func(_ int) (val interface{}, err error, abort bool) {
			var _, err1 = help.MarshalBinaryWriter(conn, locEphPub)
			if err1 != nil {
		...
		func(_ int) (val interface{}, err error, abort bool) {
			...
			var _, err2 = help.UnmarshalBinaryReader(conn, &_remEphPub, 1024*1024) // TODO
			if err2 != nil {
...
func shareAuthSignature(sc *SecretConnection, pubKey crypto.PubKey, signature []byte) (recvMsg authSigMessage, err error) {
	...
	var trs, _ = help.Parallel(
		func(_ int) (val interface{}, err error, abort bool) {
			var _, err1 = help.MarshalBinaryWriter(sc, authSigMessage{pubKey, signature})
			if err1 != nil {
				return nil, err1, true // abort
			}
			return nil, nil, false
		...
		func(_ int) (val interface{}, err error, abort bool) {
			...
			var _, err2 = help.UnmarshalBinaryReader(sc, &_recvMsg, 1024*1024) // TODO
			if err2 != nil {
				return nil, err2, true // abort
			}
