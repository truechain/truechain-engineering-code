...
func (c *Clique) VerifyFastHeader(chain consensus.ChainReader, header *types.FastHeader, seal bool) error {
	return nil
}
...
func (ethash *Clique) PrepareFast(chain consensus.ChainReader, header *types.FastHeader) error {
	return nil
}
...
// Finalize implements consensus.Engine, ensuring no uncles are set, nor block
// rewards given, and returns the final block.
func (c *Clique) FinalizeFast(chain consensus.ChainReader, header *types.FastHeader, state *state.StateDB, txs []*types.Transaction, receipts []*types.Receipt) (*types.Block, error) {
	return nil, nil
}
