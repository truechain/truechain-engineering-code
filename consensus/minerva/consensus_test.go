...
func TestCalcSnailDifficulty(t *testing.T) {
	...
	config := &params.ChainConfig{ChainID: big.NewInt(1), Minerva: &params.MinervaConfig{MinimumDifficulty: params.MinimumDifficulty, MinimumFruitDifficulty: params.MinimumFruitDifficulty, DurationLimit: params.DurationLimit}, TIP3: &params.BlockConfig{FastNumber: common.Big0}, TIP4: &params.BlockConfig{FastNumber: common.Big0}}
