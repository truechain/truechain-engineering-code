...
func newTester() *downloadTester {
	...
	tester := &downloadTester{
		...
		//ownChainTd:        map[common.Hash]*big.Int{genesis.Hash(): genesis.},
	...
	tester.fdownloader = fastdownloader.New(fastdownloader.FullSync, tester.stateDb, new(event.TypeMux), tester, nil, tester.dropPeer)
