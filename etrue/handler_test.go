...
func testGetBlockBodies(t *testing.T, protocol int) {
	...
	tests := []struct {
		...
		{0, []common.Hash{pm.blockchain.Genesis().Hash()}, []bool{true}, 1},      // The genesis.json block should be retrievable
...
func testDAOChallenge(t *testing.T, localForked, remoteForked bool, timeout bool) {
	...
	pm, err := NewProtocolManager(config, downloader.FullSync, DefaultConfig.NetworkId, evmux, new(testTxPool), nil, pow, blockchain, db)
	if err != nil {
