...
func New(eth Backend, config *params.ChainConfig, mux *event.TypeMux, engine consensus.Engine)  {
...
func (self *Miner) Pending() (*types.FastBlock, *state.StateDB) {
...
func (self *Miner) PendingBlock() *types.FastBlock {
