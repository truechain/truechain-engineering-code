...
func newPeerConnection(id string, version int, peer downloader.Peer, logger log.Logger) *peerConnection {
...
func (p *peerConnection) FetchBodies(request *downloader.FetchRequest) error {
	// Sanity check the protocol version
	if p.version < 62 {
...
func (p *peerConnection) FetchReceipts(request *downloader.FetchRequest) error {
	// Sanity check the protocol version
	if p.version < 63 {
